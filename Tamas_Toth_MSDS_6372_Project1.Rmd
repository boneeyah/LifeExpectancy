...
LifeExp = read.csv(file = 'https://raw.githubusercontent.com/boneeyah/LifeExpectancy/main/Life_Expectancy_Data.csv',header = TRUE, sep = ",")
...
#impute USA values
#USA GDP
US_GDP <- read.csv('https://raw.githubusercontent.com/boneeyah/LifeExpectancy/main/API_NY.GDP.PCAP.CD_DS2_en_csv_v2_4150786.csv',header = FALSE)
...
pop_all <- read.csv('https://raw.githubusercontent.com/boneeyah/LifeExpectancy/main/WPP2019_TotalPopulationBySex.csv')
...
adlt_mort <- read.csv('https://raw.githubusercontent.com/boneeyah/LifeExpectancy/main/Adult_mort.csv',header = TRUE)
...
barplot(fit.lasso.lm_VIF, main = 'Lasso VIF Values', horiz = TRUE, col="blue", xlim = c(0,12))
abline(v=10, col="red")
...
hist(residuals, main = "Lasso without multicolinearity \nHistogram of Residuals")
plot(residuals, main = "Lasso without multicolinearity \nResiduals plot") 
abline(h=0, col="blue")
...
par(mfrow=c(1,1))
plot(1:41,testASE,type="l",xlab="# of predictors",ylab="test vs train ASE",ylim = c(5.5,11.7))
...
barplot(fit.fwd.lm_VIF, main = 'Forward Selection VIF Values', horiz = TRUE, col="blue", xlim = c(0,12))
abline(v=10, col="red")
...
barplot(fit.fwd.lm2_VIF, main = 'Forward Selection Re-test of VIF Values', horiz = TRUE, col="blue", xlim = c(0,12))
abline(v=10, col="red")
...
### Checking Multiple Liner Regression model assumptions
confint(fit.fwd.lm3)
hist(residuals, main = "Forward Selection \nHistogram of Residuals")
plot(residuals, main = "Forward Selection \nResiduals plot") 
abline(h=0, col="blue")
