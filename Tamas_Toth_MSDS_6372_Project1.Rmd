...
KNNRegressor$pred
prediction_train = predict(KNNRegressor, KNNtrain[,-23])
prediction_test = predict(KNNRegressor, KNNtest[,-23])

#print(paste("RMSE:", KNNRegressor$resample$RMSE[1]))
#print(paste("R-squared:",KNNRegressor$resample$Rsquared[1]))
#print(paste("MAE:",KNNRegressor$resample$MAE[1]))

mse.knn  = mean((prediction_test - ytest)^2) 
