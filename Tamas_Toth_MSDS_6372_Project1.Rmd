...
library(dlookr)
library(forecast) #for getting RMSE comparing actual value to predicted value
```
```{r message = FALSE}
...
fit.lasso.lm = lm(Life.expectancy ~ Year + Adult.Mortality + Alcohol + log.percentage.expenditure + Hepatitis.B + Measles + BMI + under.five.deaths + Polio + Total.expenditure + Diphtheria + log.HIV.AIDS + thinness.5.9.years + Income.composition.of.resources + Schooling + log.GDP, data = train)
...
fit.lasso.lm3 = lm(Life.expectancy ~ Year + Status + Adult.Mortality + Alcohol + log.percentage.expenditure + Hepatitis.B + Measles + BMI + under.five.deaths + Polio + Total.expenditure + Diphtheria + log.HIV.AIDS + thinness.5.9.years + Income.composition.of.resources + Schooling + Region + log.GDP, data = train)
...
MLRT = train(
  Life.expectancy ~ Status + Region + Income.composition.of.resources + Schooling + log.HIV.AIDS + log.GDP + log.percentage.expenditure + BMI + Year + Adult.Mortality + infant.deaths,
  data = train,
  method = "lm",
  trControl = cv)
...
### Checking Multiple Liner Regression model assumptions
fit = lm(Life.expectancy ~ Status + Region + Income.composition.of.resources + Schooling + log.HIV.AIDS + log.GDP + log.percentage.expenditure + BMI + Year + Adult.Mortality + infant.deaths, train)
confint(fit)
hist(residuals, main = "Histogram of Residuals")
plot(residuals, main = "Residuals plot") 
abline(h=0, col="blue")
...
fit.custom <- lm(Life.expectancy ~Year + Status + Adult.Mortality + infant.deaths + Alcohol + percentage.expenditure + Measles + BMI +  Polio + Total.expenditure + Diphtheria + Population + thinness.5.9.years + Income.composition.of.resources + Schooling + log.HIV.AIDS + log.GDP + Meas_cat:Measles + HIV_cat:log.HIV.AIDS +HIV_cat +Meas_cat + Country +Country:infant.deaths,data = train_custom)
...
accuracy(test_custom_pred,test_custom$Life.expectancy)
