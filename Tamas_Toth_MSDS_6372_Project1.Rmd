...
```{r Objective 2 KNN, eval=FALSE, include=FALSE}
#####################################################################################
#                                      Objective 2                                  #
#                                     KNN - regression                              #
#####################################################################################
...
```{r eval=FALSE, fig.align='center', 'angle=90', include=FALSE, out.extra='angle=90'}
# Visualize 'k' and the most important features
...
```{r KNN without cross validation, eval=FALSE, include=FALSE}
#####################################################################################
#                              KNN without cross validation                         #
#####################################################################################
...
KNN is a non-parametric regression or classification algorithm. In our case we used the regression version. The algorithm uses similaroty 
